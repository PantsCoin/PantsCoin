...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pantscoin-project/pantscoin>";
    const std::string URL_WEBSITE = "<https://pantscoin.org>";
