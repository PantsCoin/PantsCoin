...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pantscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pantscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pantscoin transaction") + "\n" +
              "  pantscoin-tx [options] -create [commands]   " + _("Create hex-encoded pantscoin transaction") + "\n" +
              "\n";
